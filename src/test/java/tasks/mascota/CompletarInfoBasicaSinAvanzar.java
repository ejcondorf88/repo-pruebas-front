 ...
 * SIN hacer click en siguiente (para pruebas negativas que necesitan validar en paso 1)
 */
public class CompletarInfoBasicaSinAvanzar implements Task {
    ...
    public static CompletarInfoBasicaSinAvanzar conDatos(
        ...
        return Tasks.instrumented(CompletarInfoBasicaSinAvanzar.class,
                nombre, especie, raza, estado, edad, unidadEdad,
                fechaNacimiento, tamano, peso, sexo);
    }

    public CompletarInfoBasicaSinAvanzar(
            String nombre, String especie, String raza, String estado,
            String edad, String unidadEdad, String fechaNacimiento,
            String tamano, String peso, String sexo) {
        this.nombre = nombre;
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                // Paso 1 - Información básica (sin avanzar)
